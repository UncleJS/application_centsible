...
function StackedBar({
  ...
  const savPct = Math.max(0, 100 - subPct - expPct);
    ...
    <div className="flex flex-col gap-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div className="flex flex-col gap-1">
          <h1 className="text-2xl font-bold text-zinc-100 flex items-center gap-2">
            ...
            Forward Expense Forecast
          </h1>
          <p className="text-sm text-zinc-500">
            Projected costs based on your subscriptions, recurring expenses,
            and savings goals.
          </p>
        </div>
        ...
        {loading ? (
          ...
          <>
            <Card className="bg-zinc-900 border-zinc-800">
              ...
              <CardContent>
                <p className="text-2xl font-bold text-zinc-100 tabular-nums font-mono">
                  {formatCurrency(totals.projected.toFixed(2), currency)}
                </p>
            ...
            <Card className="bg-zinc-900 border-zinc-800">
              ...
              <CardContent>
                <p className="text-2xl font-bold text-zinc-100 tabular-nums font-mono">
                  {formatCurrency(totals.subscriptions.toFixed(2), currency)}
                </p>
                <p className="text-xs text-zinc-500 mt-1">
                  over {horizon} month{horizon !== "1" ? "s" : ""}
                </p>
      ...
      {isEmpty && (
        <div className="flex flex-col items-center justify-center gap-6 rounded-xl border border-dashed border-zinc-700 bg-zinc-900/40 py-20 text-center">
          <TrendingUp className="size-12 text-zinc-600" />
          <div className="flex flex-col gap-1">
            <p className="text-base font-semibold text-zinc-300">
              No forecast data available
            </p>
            <p className="text-sm text-zinc-500">
              Add subscriptions, recurring expenses, or savings goals to see
              your forecast.
            </p>
          </div>
        </div>
